...
<?php
$sql=("SELECT firstName FROM students WHERE studentID='{$_SESSION["studentID"]};		
}'");
  ...
  <li class="dropdown">
   ...
   <div class="log">
       ...
       <div class="admin__main-section">
          ...
          <div>
            <!-- // dashboard.php -->
          <a href="studentdashboard.php?info=profile"><i class="fa fa-user"></i>
          <P>PROFILE</P>   
          </a>
          </div>
          
          <div>
          <a href="studentdashboard.php?info=studentViewTimetable" class="">
            <i class="fa fa-eye"></i>
            <p>VIEW TIMETABLE</p>
          </a>
          </div>
          ...
          <div>
          <a href="studentdashboard.php?info=changePassword" class="">
            <i class="fa fa-eye"></i>
            <p>CHANGE PASSWORD</p>
          </a>
          </div>
          ...
          <P>Book slot</P> 
           -->
             ...
             <div class="admin-form">
				...
				// 	}
          if($info=="studentViewTimetable")
				{
					include('studentViewTimetable.php');
					}
